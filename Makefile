...
CFLAGS_16 = -m16 -O2 -w -trigraphs -fno-builtin  -fno-exceptions -fno-stack-protector -fno-rtti -nostdlib -nodefaultlibs
CCFLAGS_16 = $(CFLAGS_16) -std=c++20

	
$(BUILD_DIR)/bootloader-32.o : arch/x86/bootloader.s
	as $^ -o $@
	
$(BUILD_DIR)/bootloader-16.o : arch/x86/bootloader.c
	$(CC) -c $^ -o $@ $(CCFLAGS_16)
	
$(BUILD_DIR)/bootloader : $(BUILD_DIR)/bootloader-$(WIDTH).o
